...
angular.module('angular-rickshaw', []).directive('rickshaw', [
  '$compile',
  '$window',
  function ($compile, $window) {
    return {
      ...
      link: function (scope, element, attrs) {
            ...
            if (scope.features.xAxis) {
              if (!xAxis) {
                ...
                if (scope.features.xAxis.timeUnit) {
                  ...
                  xAxisConfig.timeUnit = time.unit(
                    scope.features.xAxis.timeUnit
                  );
                }
                ...
                if (scope.features.xAxis.ticksTreatment) {
                  xAxisConfig.ticksTreatment =
                    scope.features.xAxis.ticksTreatment;
                }
        ...
        var seriesWatch = scope.$watchCollection(
          'series',
          function (newValue, oldValue) {
            if (!angular.equals(newValue, oldValue)) {
              updateData();
...
module.exports = angular.module('angular-rickshaw').name;
